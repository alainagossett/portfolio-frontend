...
<section id="about">
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
        ...
        <div
            ...
            <a href="./AlainaGossett_Resume_03-2022.pdf" className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" download>
            Download my Resume
            </a>
            </div>
        </div>
