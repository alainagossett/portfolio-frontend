...
<section id="about">
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
        ...
        <div
            ...
            <a href='AlainaGossett_Resume032022.pdf' className="inline-flex text-white bg-dark-pink border-0 py-2 px-6 focus:outline-none hover:bg-light-pink rounded text-lg" download>
            Download my Resume
            </a>
            </div>
        </div>
