    ...
    <section id="landing">
        <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
            <div
                ...
                <h2 className='title-font sm:text-2xl text-1xl mb-2 font-medium text-grey'>
                ...
                <div className="flex justify-center">
                    <Link to="/contact"
                        className="inline-flex text-white bg-dark-pink border-0 py-2 px-6 focus:outline-none hover:bg-light-pink rounded text-lg">
                        Contact
                    </Link>
                </div>
            </div>
